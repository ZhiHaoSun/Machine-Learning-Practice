...
def save_image(im, i):
    ...
    Image.fromarray(a).save('%d.png' % i)
...
if __name__ == "__main__":
    ...
    clf = svm.SVC(C=2, kernel='rbf', gamma=0.001) # gamma is very small, approxiate to KNN
    ...
    err_images = images_test[y_test != y_hat] # images classified wrongly
    err_y_hat = y_hat[y_test != y_hat] # give higher weightage to wrong case with Adaboost
