...
# ratio of the real 1s who are classified as 1
...
if __name__ == "__main__":
    np.random.seed(0)   # 保持每次生成的数据相同 Keep same generated data every time
    c1 = 990
    c2 = 10 # unbalanced data very small
    N = c1 + c2
    ...
    clfs = [svm.SVC(C=1, kernel='linear', decision_function_shape='ovr'),
           svm.SVC(C=1, kernel='linear', decision_function_shape='ovr', class_weight={-1: 1, 1: 10}), # 1 is given higher weightage
